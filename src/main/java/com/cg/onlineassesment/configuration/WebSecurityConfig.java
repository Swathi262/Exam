package com.cg.onlineassesment.configuration;
...
import com.cg.onlineassesment.service.JwtService;
import com.cg.onlineassesment.service.UserService;
@Configuration
@EnableWebSecurity
...
public class WebSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
		...
		.authorizeRequests().requestMatchers("/authenticate","/registerNewuser").permitAll().requestMatchers("/**").permitAll()
